                ...
                <div className="low-detail-document-container">
                    ...
                    <div className="serviceBox">
                        ...
                        <div className="content">
                            ...
                            <br />
                            <Link href="https://drive.google.com/drive/folders/14XOHVjZgBtd13UbAovnOKIMv_ePLXv92?usp=drive_link" target="_blank" className="low-detail-document-button">Download</Link>
                        </div>
                    </div>
            ...
            {/* <section className="low-detail-news-main-section" id="low-detail-news-main-section">
                ...
                <section className="low-detail-post news-container news-section">
                    <div className="low-detail-post-box">
                        <Link href="https://jabaran.id/os2mn-2026-sukses-digelar-tampilkan-semangat-kompetisi-ilmiah-pelajar-madrasah-se-indonesia/" target="_blank">
                            <img src="/assets/images/news/news1baru.jpg" alt="" className="low-detail-post-img" />
                            <h2 className="low-detail-news-category">OS2MN</h2>
                            <Link href="https://jabaran.id/os2mn-2026-sukses-digelar-tampilkan-semangat-kompetisi-ilmiah-pelajar-madrasah-se-indonesia/" target="_blank" className="low-detail-post-title">OS2MN 2026 Sukses Digelar, Tampilkan Semangat Kompetisi Ilmiah Pelajar Madrasah Se-Indonesia</Link>
                            <span className="low-detail-post-date">28 April 2026</span>
                            <p className="low-detail-post-decription">Jabaran.id – Dunia pendidikan madrasah Indonesia kembali menunjukkan prestasi gemilang melalui penyelenggaraan Olimpiade Sains Siswa Madrasah Nasional (OS2MN) 2026. Ajang bergengsi yang dihelat oleh Indonesian Young Scientist Association (IYSA) untuk kedua kalinya ini berlangsung secara daring dari tanggal 10 hingga 17 April 2026, berhasil menyedot antusiasme ratusan pelajar madrasah dari berbagai penjuru tanah air.</p>
